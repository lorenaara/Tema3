...
?>
    ...
    $correcto = false;
    if (enviado()) {
        if (validarForm($_REQUEST['alfabetico'], $_REQUEST['numerico'], $_REQUEST['fecha'],  $_REQUEST['elige'],  $_REQUEST['telefono'], $_REQUEST['email'], $_REQUEST['pass'])) {
            $correcto = true;
            //echo "Todo correcto";
    ...
    ?>
        ...
        <body>
            ...
            if (enviado() && !vacio("numOpcional"))
                echo $_REQUEST['numOpcional'];
            ?>">
            </p>
            <p>
