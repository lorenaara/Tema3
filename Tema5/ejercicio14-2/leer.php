<?
    ...
    try{
        ...
        while($row= $resultado->fetch(PDO::FETCH_ASSOC)){
            ...
            echo '<td style="border:1px solid black; padding:10px"><a href="./autentificacion.php?operar=modificar&name='.$row['id'].'">Modificar</a></td>';
            echo '<td style="border:1px solid black; padding:10px"><a href="./borrar.php?operar=borrar&name='.$row['id'].'">Borrar</a></td>';
            echo '</tr>';
        }
        echo '</table>';
